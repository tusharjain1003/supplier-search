...
The screenshots show the default ranking (balanced weights) and an alternate weighting scenario where ISO importance is raised to 70 and buyer evidence is lowered to 5, changing the supplier order.
